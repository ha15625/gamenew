...
class TouranamentController {
    ...
    /**
       ...
       */
    static getPlayerTournament(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let { playerId } = req.params;
                let exists = yield Registration_1.default.find({ userId: playerId }).populate("tournament");
                return ResponseHelper_1.default.ok(res, "SUCCESS", "Get List Successfully", exists, new Date().getTime());
            }
            catch (error) {
                next(error);
            }
